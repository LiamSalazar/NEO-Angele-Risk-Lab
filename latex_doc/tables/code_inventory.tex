...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.22\linewidth}>{\RaggedRight\arraybackslash}p{0.31\linewidth}>{\RaggedRight\arraybackslash}p{0.37\linewidth}}
...
\filepath{src/neo_ange/evidence} & \code{ModelEvidenceBuilder}, predicciones, desacuerdos, tarjetas de modelo & Integra evidencia secundaria de modelos, tarjetas, inferencia completa/evaluación y desacuerdos.\\
